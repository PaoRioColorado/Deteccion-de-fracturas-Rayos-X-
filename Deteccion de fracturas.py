...
# ----------------------------------------------------------------------
# ASEGÚRATE DE QUE ESTAS RUTAS APUNTEN AL LUGAR CORRECTO EN TU PC.
# Reemplaza 'USUARIO' si es necesario.

# Raíz de las imágenes
DATA_ROOT = r"C:\Users\USUARIO\Desktop\Proyecto Deteccion de fracturas\images\Dataset\train\images"
# Raíz de las etiquetas (archivos .txt)
LABEL_ROOT = r"C:\Users\USUARIO\Desktop\Proyecto Deteccion de fracturas\images\Dataset\train\labels"
...
# ----------------------------------------------------------------------
# VISUALIZACIÓN TKINTER / PIL - (Corrección de Texto Cortado)
# ----------------------------------------------------------------------
...
def draw_image_with_boxes(im_path, boxes, box_type, meta_data=None, max_height=400):
    ...
    # DIBUJAR TÍTULO FIJO DE LA COLUMNA (CORRECCIÓN DE CORTE)
    draw.text((5, 5), 
              texto_main, 
              fill=color_main, 
              font=font_main, 
...
class FractureApp:
    def __init__(self, root, data_root):
        ...
        self.label_titulo = Label(root, text="Detección de Fracturas: Comparativa de Modelos de IA", font=("Arial",16,"bold"))
    ...
    def show_image(self, initial_load=False):
        ...
        # 3. Visualización 
        # Los meta_data ahora incluyen (confidences, ious)
        ...
        # Aquí pasamos los datos específicos del pipeline para el coloreado dinámico
        ...
        # --- Solución 2: Usar f-string en el template completo para evitar llaves rotas ---
...
if __name__ == "__main__":
    ...
    if root_error:
        # Crea una ventana simple de error si las rutas son incorrectas
        root = Tk()
        root.title("ERROR DE CONFIGURACIÓN")
        Label(root, text="¡ERROR CRÍTICO! Revise las rutas DATA_ROOT y LABEL_ROOT en el código.", font=("Arial", 16), fg="red").pack(padx=30, pady=30)
        Button(root, text="Cerrar", command=root.destroy).pack(pady=10)
        root.mainloop()
    else:
        root = Tk()
